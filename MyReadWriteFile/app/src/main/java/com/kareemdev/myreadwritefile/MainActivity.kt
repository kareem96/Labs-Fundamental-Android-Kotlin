package com.kareemdev.myreadwritefile
...
import com.kareemdev.myreadwritefile.databinding.ActivityMainBinding
    ...
    private fun saveFile() {
        when{
            binding.editTitle.text.toString().isEmpty() -> {
                Toast.makeText(this, "Title harus di isi terlebih dahulu", Toast.LENGTH_SHORT).show()
            }
