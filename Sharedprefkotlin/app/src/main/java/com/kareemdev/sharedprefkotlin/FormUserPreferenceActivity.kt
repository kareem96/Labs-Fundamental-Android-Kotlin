...
import com.kareemdev.sharedprefkotlin.databinding.ActivityFormUserPreferenceBinding
...
//        setContentView(R.layout.activity_form_user_preference)
    ...
    override fun onClick(view: View) {
        if(view.id == R.id.btn_save){
            ...
            savaUser(name, email, age, phoneNo, isLoveMU)
    ...
    private fun savaUser(name: String, email:String, age:String, phoneNo:String, isLoveMU:Boolean) {
